"""Build an explicitly non-uploadable G3A offline submission."""
...
def main() -> None:
    ...
    parser.add_argument("--questions", default="data/g3a_v1/g3a_questions.jsonl")
    ...
    print(f"G3A offline submission -> {path}")
