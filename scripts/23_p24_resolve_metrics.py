"""Print exact standard-statement metric candidates for P2.4 review."""
...
from vifinqa.devset.p24_metrics import METRICS, StandardMetricResolver  # noqa: E402
...
def main() -> None:
    ...
    resolver = StandardMetricResolver(args.store_dir)
